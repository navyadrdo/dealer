...
<form id="exampage" name="saleexecutiveform" method="post">
 ...
 <div id="login">
<p><a href="/dealer/WEB-INF/jsp/login.jsp">Login</a></p>
 </div>
...
<li><a href="/dealer/WEB-INF/html_bkp/dispach_page.html">Dispatch</a></li>
 ...
 <div id="middle">
 <h4>Adding new Sales Executive</h4>

<p><label>Empid</label><input type="text" name="Seid" value="12"/></p>
<p><label>Ename</label><input type="text" name="ename" value="adsfd"/></p>
<p><label>Username</label><input type="text" name="username" value="ravi"/></p>
<p><label>Password</label><input type="text" name="password" value="ravi"/></p>
<p><label>Retype password</label><input type="text" name="repass" value="ravi"/></p>
<p><label>D.no</label><input type="text" name="dno" value="12=12"/></p>
<p><label>Street</label><input type="text" name="street" value="fdsgsd"/></p>
