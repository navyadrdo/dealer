...
<li><a href="/dealer/html/dispach_page.html">Dispatch</a></li> 
 ...
 <h4>Payments</h4>
  ...
  <p><label>Transaction id</label><input type="text" name="txid" value="12w"/></p>
  <p><label>Item id</label><input type="text" name="itemid" value="erw"/></p>
    <p><label>Date</label><input type="text" name="ndate" value="11/11/2011"/></p>
  <p><label>Received by</label><input type="text" name="recivedby" value="sdfd"/></p>
  <p><label>Amount</label><input type="text" name="amount" value="120"/></p>
  ...
  <div class="">
  <p><label></label>
  <input type="submit" value="save" name="paymentoperation"  onclick="saveurl();"/>
	<input type="submit" value="update"name="paymentoperation" onclick="updateurl();"/>
	<input type="submit" value="search"name="paymentoperation" onclick="searchurl();"/>
	<input type="submit" value="delete"name="paymentoperation" onclick="deleteurl();"/>
	<input type="submit" value="getall"name="paymentoperation" onclick=" getallurl();"/></p>
  </div>
  </div>
  </form>
