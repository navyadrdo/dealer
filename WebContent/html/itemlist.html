...
<p><label>Item Id</label><input type="text" name="itemid" value="11"/></p>
<p><label>Item name</label><input type="text" name="itemname" value="fdsad"/></p>
<p><label>Unit Cost</label><input type="text" name="unitcost" value="12"/></p>
<p><label>Date</label><input type="text" name="edate"value="11/11/2000"/></p>
<p><label>Entered By</label><input type="text" name="enteredby" value="sdfsd"/></p>
<div class="">
<label></label>
<input type="submit" value="save" name="operation" onclick="saveurl();"/>
<input type="submit" value="update"name="operation"  onclick="updateurl();"/>
<input type="submit" value="Delete"name="operation" onclick="deleteurl();"/>
<input type="submit" value="Search"name="operation"onclick="searchurl();"/>
<input type="submit" value="getall"name="operation"onclick="getallurl();"/>
 </div>
 </div>
 </form>
